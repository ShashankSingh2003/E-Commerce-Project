...
function Footer() {
    return (
        <Fragment>
            <div>
                <footer id="lg_devices">
                    <div id="footer_one">
                        <div id="hr_email">
                            <p><i className="fa fa-envelope" /> GET SPECIAL DISCOUNT ON YOUR INBOX </p>
                            <form action>
                        ...
                        <div id="experience">
                            <div id="icon_wrapper">
                                <i className="fas fa-mobile-android-alt" />
                                <p>EXPERIENCE THE WEBREAK MOBILE APP</p>
                            </div>
                            <div id="svg_wrapper">
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width={122} height={36} viewBox="0 0 135 40">
                                    ...
                                    <linearGradient id="gpA" gradientUnits="userSpaceOnUse" x1="21.795" y1="-152.295" x2="5.012" y2="-135.513" gradientTransform="translate(0 161)">
                                    ...
                                    <linearGradient id="gpB" gradientUnits="userSpaceOnUse" x1="33.834" y1="-140.95" x2="9.637" y2="-140.95" gradientTransform="translate(0 161)">
                                        <stop offset={0} stopColor="#ffe000" />
                                        <stop offset=".409" stopColor="#ffbd00" />
                                        <stop offset=".775" stopColor="orange" />
                                        <stop offset={1} stopColor="#ff9c00" />
                                    </linearGradient>
                                    <path d="M27 24.3l-4.1-4.1v-.3l4.1-4.1.1.1 4.9 2.8c1.4.8 1.4 2.1 0 2.9l-5 2.7z" fill="url(#gpB)" />
                                    <linearGradient id="gpC" gradientUnits="userSpaceOnUse" x1="24.816" y1="-138.715" x2="2.058" y2="-115.957" gradientTransform="translate(0 161)">
                                        <stop offset={0} stopColor="#ff3a44" />
                                        <stop offset={1} stopColor="#c31162" />
                                    </linearGradient>
                                    <path d="M27.1 24.2L22.9 20 10.4 32.5c.5.5 1.2.5 2.1.1l14.6-8.4" fill="url(#gpC)" />
                                    <linearGradient id="gpD" gradientUnits="userSpaceOnUse" x1="7.261" y1="-160.788" x2="17.424" y2="-150.625" gradientTransform="translate(0 161)">
                                    ...
                                    <path d="M27.1 15.8L12.5 7.5c-.9-.5-1.6-.4-2.1.1L22.9 20l4.2-4.2z" fill="url(#gpD)" />
                    ...
                    <div id="hr_menu">
                        <div className="hr_menu_container">
                            <ul>
                                <li className='footer_logo'><img src="assets/image/WEBREAK.png" alt srcSet /></li>
                                <li><a href="nykaa_luxe.html">WHO ARE WE?</a></li>
                    ...
                    <div id="hr_social">
                        ...
                        <div id="hr_social_icons">
                            <div id="hr_social_icons_heading">
                ...
                <footer id="mobile_footer">
                    <div id="mobile_app" className="pt-3">
                        <div className="mobile_footer_heading pt-3">
                            <i className="bi bi-phone" />
                            <h6 className="text-center mb-0"> experience the Webreak mobile app</h6>
                        </div>
                        <div className="d-flex app_stores justify-content-center py-3">
                            <div className="play_store stores">
                                <svg xmlns="http://www.w3.org/2000/svg" width={122} height={36} viewBox="0 0 135 40">
                                    <title>Google Play Store</title>
                                    <path d="M130 40H5c-2.8 0-5-2.2-5-5V5c0-2.8 2.2-5 5-5h125c2.8 0 5 2.2 5 5v30c0 2.8-2.2 5-5 5z" />
                                    <path d="M130 .8c2.3 0 4.2 1.9 4.2 4.2v30c0 2.3-1.9 4.2-4.2 4.2H5C2.7 39.2.8 37.3.8 35V5C.8 2.7 2.7.8 5 .8h125m0-.8H5C2.2 0 0 2.3 0 5v30c0 2.8 2.2 5 5 5h125c2.8 0 5-2.2 5-5V5c0-2.7-2.2-5-5-5z" fill="#a6a6a6" />
                                    <path d="M47.4 10.2c0 .8-.2 1.5-.7 2-.6.6-1.3.9-2.2.9s-1.6-.3-2.2-.9c-.6-.6-.9-1.3-.9-2.2s.3-1.6.9-2.2c.6-.6 1.3-.9 2.2-.9.4 0 .8.1 1.2.3.4.2.7.4.9.7l-.5.5c-.4-.5-.9-.7-1.6-.7-.6 0-1.2.2-1.6.7-.5.4-.7 1-.7 1.7s.2 1.3.7 1.7 1 .7 1.6.7c.7 0 1.2-.2 1.7-.7.3-.3.5-.7.5-1.2h-2.2v-.8h2.9v.4zM52 7.7h-2.7v1.9h2.5v.7h-2.5v1.9H52v.8h-3.5V7H52v.7zm3.3 5.3h-.8V7.7h-1.7V7H57v.7h-1.7V13zm4.6 0V7h.8v6h-.8zm4.2 0h-.8V7.7h-1.7V7h4.1v.7H64l.1 5.3zm9.5-.8c-.6.6-1.3.9-2.2.9-.9 0-1.6-.3-2.2-.9-.6-.6-.9-1.3-.9-2.2s.3-1.6.9-2.2 1.3-.9 2.2-.9c.9 0 1.6.3 2.2.9s.9 1.3.9 2.2-.3 1.6-.9 2.2zm-3.8-.5c.4.4 1 .7 1.6.7s1.2-.2 1.6-.7c.4-.4.7-1 .7-1.7s-.2-1.3-.7-1.7c-.4-.4-1-.7-1.6-.7s-1.2.2-1.6.7c-.4.4-.7 1-.7 1.7s.2 1.3.7 1.7zm5.8 1.3V7h.9l2.9 4.7V7h.8v6h-.8l-3.1-4.9V13h-.7z" fill="#fff" stroke="#fff" strokeWidth=".2" strokeMiterlimit={10} />
                            ...
                            <div className="apple_store stores">
                                <svg xmlns="http://www.w3.org/2000/svg" id="livetype" width={122} height={36} viewBox="0 0 119.66407 40">
                                    <title>Download_on_the_App_Store_Badge_US-UK_RGB_blk_4SVG_092917</title>
                                    <g>
                                        <g>
                                            <g>
                        ...
                        <div className="socials pb-3">
                            <h6 className="text-dark text-center">show us some love ❤ on social media</h6>
                            <div className="d-flex justify-content-center">
                ...
                <a className="position-fixed top-button" href="#hero">
